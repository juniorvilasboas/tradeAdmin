  ...
  return (
    <>
      <h1 className='text-2xl md:text-4xl font-semibold text-gray-800 dark:text-white'>
        {Data.Saudacao()}, {session?.user?.name}
      </h1>
      <h2 className='text-xs md:text-md text-gray-400'>
        O que está acontecendo com sua conta hoje.
      </h2>
      <div className='flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row'>
        ...
        <Profit type='gain' quant={10} />
        <Profit type='loss' quant={5} />
      </div>
      <div className='flex items-center space-x-4'>
        <button className='flex items-center text-gray-400 text-sm md:text-md border-gray-300 border px-4 py-2 rounded-tl-sm rounded-bl-full rounded-r-full'>
          <svg
            width={20}
            height={20}
            fill='currentColor'
